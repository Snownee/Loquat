...
public class LycheeCompat {
	...
	public static final LootContextParamSet LOOT_CONTEXT_PARAM_SET = LootContextParamSetsAccess.callRegister(
			SPAWNER_ID.toString(), $ -> $.required(LootContextParams.ORIGIN));
	public static final LoquatDataLoader<Spawner> SPAWNERS = new LoquatDataLoader<>(
			SPAWNER_ID, "loquat_spawners", $ -> LoquatDataLoader.GSON.fromJson($, Spawner.class));
	public static final LoquatDataLoader<Difficulty> DIFFICULTIES = new LoquatDataLoader<>(
			DIFFICULTY_ID, "loquat_difficulties", $ -> LoquatDataLoader.GSON.fromJson($, Difficulty.class));
